<?php
    ...
    $mail->Host = 'smtp.online.net'; //serveur de messagerie
    $mail->Port = 587; //port orange
    $mail->SMTPAuth = true; //on fournit login/password
    $mail->SMTPSecure = 'tsl'; //certificat ssl
    $mail->Username = 'contact@lauradev.fr'; //utilisateur SMTP
    $mail->Password = 'Loles3434$'; //mdp
    $mail->SetFrom($safe['mail'], $safe['name']); //expediteur du mail
    $mail->addAddress('contact@lauradev.fr'); //le destinataire
